...
public class UpComingFragment extends Fragment {
    ...
    public void AnhXa(ListView lvActivity)
    {
        ...
        ApiService.apiService.listActivittyOfStudentFuture(GetStudent).enqueue(new Callback<List<Activity>>() {
            @Override
            public void onResponse(Call<List<Activity>> call, Response<List<Activity>> response) {
                listActivity =  response.body();
                if (listActivity!=null)
                {
                    adapterActivity=new ActivityAdapter(UpComingFragment.this.getContext(), R.layout.line_activity, listActivity, "Đăng ký", GetStudent);
            ...
            public void onFailure(Call<List<Activity>> call, Throwable t) {
                ...
                Toast.makeText(UpComingFragment.this.getContext(), "Call API Error", Toast.LENGTH_SHORT).show();
            }
        });
    }
}